<template>
  ...
  <div class="text-center">
    <div class="mb-8">
      ...
      <h2 class="text-2xl font-semibold text-gray-700 mb-2">{{ $t('notFound.title') }}</h2>
    ...
    <div class="space-y-4">
      ...
      <div class="mt-8">
        <h3 class="text-lg font-medium text-gray-900 mb-4">{{ $t('layout.quickAccessPages') }}</h3>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <router-link
            to="/dashboard"
            class="p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200"
          >
            <div class="text-center">
              <svg class="w-8 h-8 text-blue-500 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
               <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              <p class="text-sm font-medium text-gray-900">{{ $t('navigation.dashboard') }}</p>
            </div>
          </router-link>
          ...
          >
            <div class="text-center">
              ...
              <p class="text-sm font-medium text-gray-900">{{ $t('navigation.employees') }}</p>
            </div>
          </router-link>
          ...
          >
            <div class="text-center">
              ...
              <p class="text-sm font-medium text-gray-900">{{ $t('navigation.documents') }}</p>
            </div>
          </router-link>
          ...
          >
            <div class="text-center">
              ...
              <p class="text-sm font-medium text-gray-900">{{ $t('navigation.settings') }}</p>
            </div>
          </router-link>
        </div>
      </div>
