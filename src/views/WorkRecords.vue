        ...
        <div class="bg-white shadow rounded-lg p-6 mb-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-blue-50 p-4 rounded-lg">
              <dt class="text-sm font-medium text-blue-900">
                {{ $t('workRecords.totalWorkDays') }}
              </dt>
            ...
            <div class="bg-yellow-50 p-4 rounded-lg">
              <dt class="text-sm font-medium text-yellow-900">
                {{ $t('workRecords.totalOvertime') }}
              </dt>
            ...
            <div class="bg-purple-50 p-4 rounded-lg">
              <dt class="text-sm font-medium text-purple-900">
                {{ $t('workRecords.averageHours') }}
              </dt>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <option value="regular">
                  {{ $t('workRecords.regularShift') }}
                </option>
                <option value="morning">
                  {{ $t('workRecords.morningShift') }}
                </option>
                <option value="evening">
                  {{ $t('workRecords.eveningShift') }}
                </option>
                <option value="night">
                  {{ $t('workRecords.nightShift') }}
                </option>
                <option value="split">
                  {{ $t('workRecords.split') }}
                </option>
            ...
            <div>
              ...
              >
                ...
                <option value="regular">
                  {{ $t('workRecords.regularWork') }}
                </option>
                <option value="overtime">
                  {{ $t('workRecords.overtime') }}
                </option>
                <option value="holiday">
                  {{ $t('workRecords.holiday') }}
                </option>
                <option value="night">
                  {{ $t('workRecords.nightWork') }}
                </option>
                <option value="remote">
                  {{ $t('workRecords.remoteWork') }}
                </option>
                <option value="business_trip">
                  {{ $t('workRecords.businessTrip') }}
                </option>
                <option value="training">
                  {{ $t('workRecords.training') }}
                </option>
              </select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <option value="pending">
                  {{ $t('workRecords.pending') }}
                </option>
                <option value="approved">
                  {{ $t('workRecords.approved') }}
                </option>
                <option value="rejected">
                  {{ $t('workRecords.rejected') }}
                </option>
              </select>
            </div>
          ...
          <div class="grid grid-cols-7 gap-2">
            ...
            >
              ...
              <div
                ...
                :key="record.id"
                class="text-xs bg-blue-100 text-blue-800 rounded px-1 py-0.5 mb-1 truncate"
              >
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <div class="space-y-4">
                ...
                <div class="bg-blue-50 p-3 rounded-md">
                  ...
                  <div
                    v-if="calculatedHours > 8"
                    class="text-sm text-blue-900 mt-1"
                  >
